...
public class ManagePersonServlet extends HttpServlet {
    ...
    private String validatePersonFMLName(Person person) {
        ...
        if (!person.validateFMLNamePart(person.getPatronymic(), true)) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (add_go != null) {
            ...
            Person new_person = new Person(request.getParameter("name"), request.getParameter("surname"), request.getParameter("patronymic"));
        ...
        if (edit_go != null) {
            ...
            updatable_person.setPatronymic(request.getParameter("patronymic"));
