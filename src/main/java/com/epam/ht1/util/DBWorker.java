...
public class DBWorker {
    private static final String DB_URL = "jdbc:mysql://localhost/phonebook?&useUnicode=true&characterEncoding=UTF-8&characterSetResults=utf8&connectionCollation=utf8_general_ci";
